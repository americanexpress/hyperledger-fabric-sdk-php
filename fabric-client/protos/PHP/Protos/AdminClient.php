...
namespace Protos {
  ...
  class AdminClient extends \Grpc\BaseStub {
    ...
    public function StopServer(\Google\Protobuf\GPBEmpty $argument,
     ...
     // @param \Protos\LogLevelRequest $argument input argument
     // @param array $metadata metadata
     // @param array $options call options
    public function GetModuleLogLevel(\Protos\LogLevelRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/protos.Admin/GetModuleLogLevel',
      $argument,
      ['\Protos\LogLevelResponse', 'decode'],
      $metadata, $options);
    }
     ...
     // @param array $metadata metadata
     // @param array $options call options
    public function SetModuleLogLevel(\Protos\LogLevelRequest $argument,
      $metadata = [], $options = []) {
